-- vPeddler compatibility module for pfUI bags
...
-- Debug command
SLASH_VPEDDLERPFUI1 = "/vpp"
SlashCmdList["VPEDDLERPFUI"] = function(msg)
    if msg == "debug" then
        debugMode = not debugMode
        DEFAULT_CHAT_FRAME:AddMessage("|cFF99CC33vPeddler|r: pfUI debug mode " .. (debugMode and "enabled" or "disabled"))
    elseif msg == "update" then
        DEFAULT_CHAT_FRAME:AddMessage("|cFF99CC33vPeddler|r: Forcing complete icon refresh...")
        ForceFullIconRefresh()
    elseif msg == "settings" then
        -- Display current settings
        if vPeddlerDB then
            DEFAULT_CHAT_FRAME:AddMessage("|cFF99CC33vPeddler|r: Current settings:")
            DEFAULT_CHAT_FRAME:AddMessage("  Icon Size: " .. tostring(vPeddlerDB.iconSize))
            DEFAULT_CHAT_FRAME:AddMessage("  Icon Alpha: " .. tostring(vPeddlerDB.iconAlpha))
            DEFAULT_CHAT_FRAME:AddMessage("  Icon Position: " .. tostring(vPeddlerDB.iconPosition))
            DEFAULT_CHAT_FRAME:AddMessage("  Icon Texture: " .. tostring(vPeddlerDB.iconTexture))
            DEFAULT_CHAT_FRAME:AddMessage("  Icon Outline: " .. tostring(vPeddlerDB.iconOutline))
        else
            DEFAULT_CHAT_FRAME:AddMessage("|cFF99CC33vPeddler|r: vPeddlerDB not available")
        end
    end
end
